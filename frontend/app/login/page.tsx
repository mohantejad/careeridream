            ...
            <div className="rounded-3xl border border-white/10 bg-[#0f1720]/85 p-8 shadow-2xl shadow-black/40">
              <div className="space-y-2 text-center">
                ...
                <h1 className={`${space.className} text-3xl`}>
                  Log in to careerIDream
                </h1>
                <p className="text-sm text-white/70">
                  Continue where you left off and build your next application.
                </p>
              </div>
              ...
              <form className="mt-8 space-y-4" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between">
                    <label className="flex items-center gap-2 text-xs text-white/60">
                      <input
                        type="checkbox"
                        className="h-4 w-4 rounded border-white/20 bg-[#0c1218]"
                ...
                <button
                  type="submit"
                  className="mt-2 w-full rounded-full bg-[#6de5c1] px-6 py-3 text-sm font-semibold text-[#0c1116] transition hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-60"
              ...
              <div>
                ...
                <p className="mt-3 text-center text-xs text-white/50">
                  We will redirect you to Google to finish sign in.
                </p>
              </div>

              <p className="mt-6 text-center text-xs text-white/60">
                New here?{" "}
                <Link className="text-[#6de5c1] hover:text-[#a8f0d8]" href="/signup">
                  Create an account
                </Link>
              </p>
            </div>
